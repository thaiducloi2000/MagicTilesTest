...
static class DebugInspector
{
    [MenuItem("T70/Tools/Toggle Inspector Mode &#1")] //Change the shortcut here
            ...
            if (field != null)
            {
                ...
                if (method != null)
                    method.Invoke(targetInspector,
                        new object[]
                            {mode}); //Call the function on our targetInspector, with the new mode as an object[]
            }
