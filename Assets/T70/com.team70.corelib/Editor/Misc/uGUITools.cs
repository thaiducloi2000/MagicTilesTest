...
namespace UnityEngine.UI.Extensions
{
    ...
    {
        [MenuItem("T70/uGUI/Anchors to Corners %[")]
        static void AnchorsToCorners()
        {
            foreach (Transform transform in Selection.transforms)
            {
                ...
                Undo.RecordObject(t, "Paste Anchors RectTransform Values");
        ...
        [MenuItem("T70/uGUI/Corners to Anchors %]")]
        ...
        [MenuItem("T70/uGUI/Mirror Horizontally Around Anchors %;")]
        static void MirrorHorizontallyAnchors()
        {
            MirrorHorizontally(false);
        }

        [MenuItem("T70/uGUI/Mirror Horizontally Around Parent Center %:")]
        ...
        [MenuItem("T70/uGUI/Mirror Vertically Around Anchors %'")]
        static void MirrorVerticallyAnchors()
        {
            MirrorVertically(false);
        }

        [MenuItem("T70/uGUI/Mirror Vertically Around Parent Center %\"")]
