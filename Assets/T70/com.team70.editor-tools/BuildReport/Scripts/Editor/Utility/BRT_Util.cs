...
namespace BuildReportTool
{
	public static class Util
	{
		...
		public static string GetPackageFileContents(string filename)
		{
			...
			string defaultBuildReportToolFullPath = BuildReportTool.Options.BUILD_REPORT_TOOL_DEFAULT_PATH;
...
#endif
			string folderPath = BuildReportTool.Options.BUILD_REPORT_TOOL_DEFAULT_PATH;
